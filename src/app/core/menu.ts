...
export const MENU = [
    ...
    group(
        ...
        'assets/icons/menu-katalog.svg', '', ['manage_categorys', 'manage_attribytegroups', 'manage_attribytes', 'manage_options', 'manage_products', 'manage_productpromotions', 'manage_collections']
    ),
    group(
    ...
    group('MENU.manage_site.manage_site', [
            ...
            item('MENU.liqpay', 'liqpay', true, ICON_MENU_ITEM, 'manage_currencys'),
