...
export const environment = {
    ...
    catalog: {
        ...
        option: {
            ...
            productOption: host + `product_option`,
            productOpt: host + `product_option/options`,
            productOptVal: host + `product_option_value`,
            productAllOptVal: host + `product_option_value/values`
        },
        category: {
